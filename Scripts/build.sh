...
hdiutil create -quiet -volname BlinkOtter -srcfolder build/dmg -ov -format UDZO build/BlinkOtter-0.3.0-arm64.dmg
hdiutil verify build/BlinkOtter-0.3.0-arm64.dmg
echo "Built $APP and $PWD/build/BlinkOtter-0.3.0-arm64.dmg"
